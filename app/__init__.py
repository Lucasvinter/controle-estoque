...
from app.domains.fornecedor.views import app_fornecedor
from app.domains.marca.views import app_marca
from app.domains.produtos.views import app_produtos
